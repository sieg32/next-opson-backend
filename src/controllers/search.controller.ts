...
export const searchController = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const parsedParams = {
      ...
      property_type:property_type ? property_type as string : undefined,
      ...
      property_id:property_id ? property_id as string : undefined,
      city:city ? city as string : undefined,
      landmark: landmark ? landmark as string :undefined,
      ...
      listed_by:listed_by ? listed_by as string : undefined,
